		...
		datasets: [
			{
				...
				fill: true,
				tension: 0.4,
				data: [500, 700, 800, 600, 900, 1000, 750, 850, 950, 1100, 1200, 1000],
			},
		],
	};
			...
			<div className="max-w-7xl mx-auto p-6">
				...
				<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
					...
					<StatCard
						...
						value={data.totalPendingRequests}
				...
				<div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
					<div className="shadow-md border border-gray-200 rounded-xl p-5 flex flex-col">
						<h3 className="text-xl font-semibold text-primary mb-4 flex items-center gap-2">
							<PieChart className="text-primary" /> Request Status
						</h3>
					...
					<div className="shadow-md border border-gray-200 rounded-xl p-5 flex flex-col">
						<h3 className="text-xl font-semibold text-primary mb-4 flex items-center gap-2">
							<Users className="text-primary" /> Role Distribution
						</h3>
					...
					<div className="shadow-md border border-gray-200 rounded-xl p-5 flex flex-col">
						<div className="flex justify-between items-center mb-4">
							<h3 className="text-xl font-semibold text-primary flex items-center gap-2">
								<TrendingUp className="text-primary" /> Expense Trends
							</h3>
							<Dropdown
								value={chartView}
