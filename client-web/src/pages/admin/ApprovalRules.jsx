            ...
            <div className="card p-5 max-w-4xl mx-auto space-y-6">
                ...
                <div>
                    ...
                    <Dropdown
                        value={formData.user}
                        options={userOptions}
                        onChange={(e) => handleChange({ target: { name: 'user', value: e.value } })}
                ...
                <div className="flex gap-4 items-center">
                    <div className="flex-1">
                        <label className="block mb-1 text-base font-medium text-text">Manager</label>
                        <Dropdown
                    ...
                    <div className="flex items-center gap-2 mt-6">
                        ...
                        />
                        <label htmlFor="isManagerApprover" className="text-primary font-semibold fs-xl">
                    ...
                    {['percentage', 'specific', 'hybrid'].map((type) => (
                        <div className="flex items-center gap-2" key={type}>
                            <RadioButton
                                ...
                                onChange={(e) =>
                                    handleChange({ target: { name: 'approvalType', value: e.value } })
                                }
                            />
                            <label htmlFor={type}>
                                {type === 'percentage'
                ...
                <div className="flex gap-2 items-center mt-4">
                    ...
                    />
                    <Button label="Add Approver" className={btnClasses} onClick={handleAddApprover} />
                </div>
                                        ...
                                        >
                                            {(provided, snapshot) => (
                                                <div
                                                    ...
                                                    className={`grid grid-cols-4 items-center p-2 border-b border-gray-200 hover:bg-gray-50 ${snapshot.isDragging ? 'bg-blue-100' : ''
                                                        }`}
                                                >
                                                    <div className="text-center">{index + 1}</div> {/* Order No */}
                                                    <div>{approver.label}</div>
                                                    <div className="flex justify-center">
                                                        <Checkbox
                                                            checked={approver.specific}
                                                            disabled={formData.approvalType === 'percentage'}
                                                            onChange={(e) =>
                                                                handleApproverFieldChange(index, 'specific', e.checked)
                                                            }
                                                        />
                                                    </div>
                                                    <div className="flex justify-center">
                                                        <Checkbox
                                                            ...
                                                            disabled={formData.approvalType === 'specific'}
                                                            onChange={(e) =>
                                                                handleApproverFieldChange(index, 'required', e.checked)
                                                            }
                                                        />
                                                    </div>
                                                </div>
                ...
                {formData.approvalType !== 'specific' && (
                    <div>
                        ...
                        <InputNumber
                            ...
                            onValueChange={(e) =>
                                setFormData((prev) => ({ ...prev, minimumApprovalPercentage: e.value }))
                            }
                            className={baseInputClasses}
                            suffix="%"
                            min={0}
                ...
                <div className="text-right mt-4">
                    <Button type="submit" label="Save Rule" className={btnClasses} onClick={handleSubmit} />
                </div>
            </div>
        </PageLayout>
    );
